...
public class TitleTextCell extends LinearLayout {
    ...
    public TitleTextCell(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        title = a.getString(R.styleable.TitleTextCell_title);
        text = a.getString(R.styleable.TitleTextCell_text);
        divider = a.getBoolean(R.styleable.TitleTextCell_isdivider, false);
        a.recycle();
        init();
    }
